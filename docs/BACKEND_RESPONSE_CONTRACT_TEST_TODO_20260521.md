...
- **Implementation status:** Core read endpoints are locked by `docs/NODE_CONTROLLER_RESPONSE_CONTRACT_TESTS_DESIGN_VERIFICATION_20260522.md`. The first relation DTO set is locked by `docs/NODE_CONTROLLER_RELATION_RESPONSE_CONTRACT_TESTS_DESIGN_VERIFICATION_20260522.md`. Current follow-up locks rendition relation DTOs. Permissions remain a separate follow-up slice.
