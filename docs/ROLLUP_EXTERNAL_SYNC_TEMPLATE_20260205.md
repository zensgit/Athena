# Athena ECM External Sync Template (2026-02-05)

## 中文简版（群消息）
```
【Athena ECM 发布 v2026.02.05】
- 新增：邮件自动化报表/诊断、搜索高亮与可解释性、权限模板历史/对比/CSV 导出、预览失败重试可视化+批量重试
...
## 英文简版（Email/Slack）
```
[Athena ECM Release v2026.02.05]
- Added: mail automation reporting/diagnostics, search highlights/explainability, permission template history/compare/CSV export, preview retry visibility + bulk retry
