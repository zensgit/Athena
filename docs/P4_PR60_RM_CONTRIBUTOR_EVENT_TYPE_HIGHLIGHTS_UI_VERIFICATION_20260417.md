# PR-60 RM Contributor Event-Type Highlights UI Verification
...
- added page coverage for:
  - card rendering
  - nested current-window audit drilldown
  - failure isolation
...
- local `Claude Code CLI` remains unusable on this machine because it still returns `Not logged in · Please run /login`
