...
test('account menu shows Tags/Categories for admin/editor roles', async () => {
  ...
  expect(screen.getByRole('menuitem', { name: 'OAuth Credentials' })).toBeTruthy();
  ...
  expect(screen.getByRole('menuitem', { name: 'Template Engine' })).toBeTruthy();
  expect(screen.getByRole('menuitem', { name: 'Script Engine' })).toBeTruthy();
...
test('account menu hides Tags/Categories for viewer role', async () => {
  ...
  expect(screen.queryByRole('menuitem', { name: 'OAuth Credentials' })).toBeNull();
  ...
  expect(screen.queryByRole('menuitem', { name: 'Template Engine' })).toBeNull();
  expect(screen.queryByRole('menuitem', { name: 'Script Engine' })).toBeNull();
