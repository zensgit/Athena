...
test('PDF preview shows dialog and controls', async ({ page, request }) => {
  ...
  await page.waitForSelector('.react-pdf__Page__canvas', { timeout: 60000 });
