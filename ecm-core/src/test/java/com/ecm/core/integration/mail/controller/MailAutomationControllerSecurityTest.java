...
class MailAutomationControllerSecurityTest {
    ...
    void providerPresetsAllowAdminAndExposeNoSecrets() throws Exception {
        ...
        String body = mockMvc.perform(get("/api/v1/integration/mail/provider-presets"))
            ...
            .andExpect(jsonPath("$[0].smtpHost").value("smtp.qiye.aliyun.com"))
            .andExpect(jsonPath("$[0].smtpPort").value(465))
            .andExpect(jsonPath("$[0].smtpSecurity").value("SSL"))
            ...
            .andExpect(jsonPath("$[1].smtpHost").value("smtp.exmail.qq.com"))
            .andExpect(jsonPath("$[1].smtpPort").value(465))
            .andExpect(jsonPath("$[1].smtpSecurity").value("SSL"))
            ...
            .andExpect(jsonPath("$[2].smtpHost").value("hwsmtp.exmail.qq.com"))
            .andExpect(jsonPath("$[2].smtpPort").value(465))
            .andExpect(jsonPath("$[2].smtpSecurity").value("SSL"))
            ...
            .andExpect(jsonPath("$[3].smtpHost").value("smtp.263.net"))
            .andExpect(jsonPath("$[3].smtpPort").value(465))
            .andExpect(jsonPath("$[3].smtpSecurity").value("SSL"))
            ...
            .andExpect(jsonPath("$[4].smtpHost").value("smtpw.263.net"))
            .andExpect(jsonPath("$[4].smtpPort").value(465))
            .andExpect(jsonPath("$[4].smtpSecurity").value("SSL"))
