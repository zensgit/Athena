...
class VersionServiceLegalHoldTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(versionService, "legalHoldService", legalHoldService);
    }

    @Test
    @DisplayName("deleteVersion rejects held document")
    void deleteVersionRejectsHeldDocument() {
        ...
        doThrow(new IllegalOperationException("held")).when(legalHoldService).assertOperationAllowed(document, "delete version");
