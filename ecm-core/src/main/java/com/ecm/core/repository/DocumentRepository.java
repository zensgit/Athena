...
public interface DocumentRepository extends JpaRepository<Document, UUID>, JpaSpecificationExecutor<Document> {
    ...
    @Query("SELECT COUNT(d) FROM Document d WHERE d.deleted = false AND d.path LIKE :pathPrefix")
    long countByDeletedFalseAndPathLike(@Param("pathPrefix") String pathPrefix);
